...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, GPIO_PIN_9|GPIO_PIN_10|GPIO_PIN_2, GPIO_PIN_RESET);
  ...
  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_10
                          |GPIO_PIN_11|LCD_CS_Pin|GPIO_PIN_3|GPIO_PIN_4
                          |GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_8
                          |GPIO_PIN_9, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LCD_DC_Pin|LCD_RST_Pin|GPIO_PIN_10|GPIO_PIN_11
                          |LED_Pin|GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_15
  ...
  /*Configure GPIO pins : LCD_DC_Pin LCD_RST_Pin PD10 PD11
                           LED_Pin PD13 PD14 PD15
                           PD0 PD1 PD2 PD3
                           PD4 PD5 PD6 PD7 */
  GPIO_InitStruct.Pin = LCD_DC_Pin|LCD_RST_Pin|GPIO_PIN_10|GPIO_PIN_11
                          |LED_Pin|GPIO_PIN_13|GPIO_PIN_14|GPIO_PIN_15
                          |GPIO_PIN_0|GPIO_PIN_1|GPIO_PIN_2|GPIO_PIN_3
